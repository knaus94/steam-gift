...
SteamGift.prototype.getTransactionStatus = function (transid, count, callback) {
    return StdLib.Promises.callbackPromise(null, callback, true, (accept, reject) => {
        this.request.get({
            ...
            if (body.success == EResult.Fail && body.purchasereceipt == 3) {
...
SteamGift.prototype.getTransactionAssetID = function (transid, callback) {
    return StdLib.Promises.callbackPromise(null, callback, true, (accept, reject) => {
        this.request.get({
            ...
            if (href === undefined) {
                return reject(new Error(`Error Parse AssetID`));
            }

            return accept(parse.split('https://steamcommunity.com/my/inventory/#753_1_')[1]);
        });
    });
};