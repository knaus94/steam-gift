...
SteamGift.prototype.setCookie = function (cookie) {
	...
	this._jar.setCookie(cookie, (isSecure ? "https://" : "http://") + "help.steampowered.com");
};
...
SteamGift.prototype.delCookie = function (cookieName) {
	let urls = ["https://steamcommunity.com", "https://store.steampowered.com", "https://help.steampowered.com"]
	const cookies = []

	for (const url of urls) {
		cookies[url] = this._jar.getCookieString(url).split(';');
	}
