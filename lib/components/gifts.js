 ...
 * @param {number} gifteeAccountID Giftee Account ID
 ...
 * @returns {Promise} 
 */
SteamGift.prototype.initTransaction = function (region, gifteeAccountID, gifteeName, giftMessage, giftSentiment, callback) {
    return StdLib.Promises.callbackPromise(null, callback, true, (accept, reject) => {
