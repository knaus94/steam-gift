 ...
 * @param {string} gifteeSteamID Giftee Steam ID
 ...
 * @returns {Promise} 
 */
SteamGift.prototype.initTransaction = function (region, gifteeSteamID, gifteeName, giftMessage, giftSentiment, callback) {
    return StdLib.Promises.callbackPromise(null, callback, true, (accept, reject) => {
        if(typeof gifteeSteamID === 'string') {
            gifteeSteamID = new SteamID(gifteeSteamID);
        }
