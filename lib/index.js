 ...
 */
 SteamGift.prototype.delCookie = function(cookieName, https = true) {
	...
	this._jar.setCookie(Request.cookie(cookie), (https ? "https://" : "http://") + "store.steampowered.com", new Date(+0));
	this._jar.setCookie(Request.cookie(cookie), (https ? "https://" : "http://") + "steamcommunity.com", new Date(+0));
};
